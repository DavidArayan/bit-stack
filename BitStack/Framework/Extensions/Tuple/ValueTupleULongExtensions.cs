...
namespace BitStack {
     ...
     * with Tuples.
     */
    public static sealed class ValueTupleULongExtensions {
        ...
        public static ValueTuple<ValueTuple<byte, byte, byte, byte>, ValueTuple<byte, byte, byte, byte>> SplitIntoByte(this ulong value) {
            ...
            var i2 = (byte) (value >> 40);
            var i3 = (byte) (value >> 32);

            var i4 = (byte) (value >> 24);
            var i5 = (byte) (value >> 16);
            var i6 = (byte) (value >> 8);
            var i7 = (byte) (value);
        ...
        public static ValueTuple<ValueTuple<sbyte, sbyte, sbyte, sbyte>, ValueTuple<sbyte, sbyte, sbyte, sbyte>> SplitIntoSByte(this ulong value) {
            ...
            var i2 = (sbyte) (value >> 40);
            var i3 = (sbyte) (value >> 32);

            var i4 = (sbyte) (value >> 24);
            var i5 = (sbyte) (value >> 16);
            var i6 = (sbyte) (value >> 8);
            var i7 = (sbyte) (value);
